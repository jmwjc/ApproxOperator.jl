...
function (op::Operator{:∫vᵢσdΩ_mohr_coulomb})(ap::T,k::AbstractMatrix{Float64},fint::AbstractVector) where T<:AbstractElement
    ...
    for ξ in 𝓖
        ...
        if fᵗʳ > tol
            ...
            Cᵗ₁₁₁₁=Cᵢᵢᵢᵢ-(4.0*sin²𝜙*λ^2 + 8.0*sin²𝜙psin𝜙*λ*μ*n₁⁽¹⁾^2 + 8.0*(sin(𝜙)^2-sin(𝜙))*λ*μ*n₁⁽³⁾^2-8.0cos(𝜙)^2*μ^2*n₁⁽¹⁾^2*n₁⁽³⁾^2+4.0*(sin(𝜙)+1)^2*μ^2*n₁⁽¹⁾^4+4.0*(sin(𝜙)-1)^2*μ^2*n₁⁽³⁾^4)/4(sin(𝜙)^2*λ+4(1.0+sin(𝜙)^2)*μ)
            Cᵗ₂₂₂₂=Cᵢᵢᵢᵢ-(4.0*sin²𝜙*λ^2 + 8.0*sin²𝜙psin𝜙*λ*μ*n₂⁽¹⁾^2 + 8.0*(sin(𝜙)^2-sin(𝜙))*λ*μ*n₂⁽³⁾^2-8.0cos(𝜙)^2*μ^2*n₂⁽¹⁾^2*n₂⁽³⁾^2+4.0*(sin(𝜙)+1)^2*μ^2*n₂⁽¹⁾^4+4.0*(sin(𝜙)-1)^2*μ^2*n₂⁽³⁾^4)/4(sin(𝜙)^2*λ+4(1.0+sin(𝜙)^2)*μ)
            Cᵗ₃₃₃₃=Cᵢᵢᵢᵢ-(4.0*sin²𝜙*λ^2 + 8.0*sin²𝜙psin𝜙*λ*μ*n₃⁽¹⁾^2 + 8.0*(sin(𝜙)^2-sin(𝜙))*λ*μ*n₃⁽³⁾^2-8.0cos(𝜙)^2*μ^2*n₃⁽¹⁾^2*n₃⁽³⁾^2+4.0*(sin(𝜙)+1)^2*μ^2*n₃⁽¹⁾^4+4.0*(sin(𝜙)-1)^2*μ^2*n₃⁽³⁾^4)/4(sin(𝜙)^2*λ+4(1.0+sin(𝜙)^2)*μ)
            Cᵗ₁₁₂₂=Cᵢᵢⱼⱼ-(4.0*sin²𝜙*λ^2 + 4.0*sin²𝜙psin𝜙*λ*μ*(n₁⁽¹⁾^2+n₂⁽¹⁾^2)+4.0*(sin(𝜙)^2-sin(𝜙))*λ*μ*(n₁⁽³⁾^2+n₂⁽³⁾^2)+4.0*(sin(𝜙)+1)^2*μ^2*n₁⁽¹⁾^2*n₂⁽¹⁾^2-4.0cos(𝜙)^2*μ^2*(n₁⁽³⁾^2*n₂⁽¹⁾^2+n₁⁽¹⁾^2*n₂⁽³⁾^2)+4.0*(sin(𝜙)-1)^2*μ^2*n₁⁽³⁾^2*n₂⁽³⁾^2)/4(sin(𝜙)^2*λ+4(1.0+sin(𝜙)^2)*μ)
            Cᵗ₁₁₃₃=Cᵢᵢⱼⱼ-(4.0*sin²𝜙*λ^2 + 4.0*sin²𝜙psin𝜙*λ*μ*(n₁⁽¹⁾^2+n₃⁽¹⁾^2)+4.0*(sin(𝜙)^2-sin(𝜙))*λ*μ*(n₁⁽³⁾^2+n₃⁽³⁾^2)+4.0*(sin(𝜙)+1)^2*μ^2*n₁⁽¹⁾^2*n₃⁽¹⁾^2-4.0cos(𝜙)^2*μ^2*(n₁⁽³⁾^2*n₃⁽¹⁾^2+n₁⁽¹⁾^2*n₃⁽³⁾^2)+4.0*(sin(𝜙)-1)^2*μ^2*n₁⁽³⁾^2*n₃⁽³⁾^2)/4(sin(𝜙)^2*λ+4(1.0+sin(𝜙)^2)*μ)
            Cᵗ₂₂₃₃=Cᵢᵢⱼⱼ-(4.0*sin²𝜙*λ^2 + 4.0*sin²𝜙psin𝜙*λ*μ*(n₂⁽¹⁾^2+n₂⁽¹⁾^2)+4.0*(sin(𝜙)^2-sin(𝜙))*λ*μ*(n₂⁽³⁾^2+n₂⁽³⁾^2)+4.0*(sin(𝜙)+1)^2*μ^2*n₂⁽¹⁾^2*n₂⁽¹⁾^2-4.0cos(𝜙)^2*μ^2*(n₂⁽³⁾^2*n₂⁽¹⁾^2+n₂⁽¹⁾^2*n₂⁽³⁾^2)+4.0*(sin(𝜙)-1)^2*μ^2*n₂⁽³⁾^2*n₂⁽³⁾^2)/4(sin(𝜙)^2*λ+4(1.0+sin(𝜙)^2)*μ)
            Cᵗᵢⱼᵢⱼ = Cᵢⱼᵢⱼ
        else
