        ...
        if abs(1.0-v) < 1e-12
            ...
            if εₙ > 0.0
                ...
                if 𝑓 < 0.0
                   ...
                   Cʳ₁₂₂₂ =  μ*(n₂*s₂+n₂*s₂)*(n₁*s₂+n₂*s₁)
                   Cʳ₁₂₁₂ =  μ*(n₁*s₂+n₂*s₁)*(n₁*s₂+n₂*s₁)
                  # if μ̄ *𝑝*signτ*2*n₁*s₁ ≠ Cᶠ₁₁₁₁*ε₁₁+Cᶠ₁₁₁₂*ε₁₂+Cᶠ₁₁₂₂*ε₂₂
                  #     p1 = μ̄ *𝑝*signτ*(n₁*s₂+n₂*s₁)
                  # 
                  #     p2 =  2Cᶠ₁₂₁₂*ε₁₂+Cᶠ₁₂₂₂*ε₂₂+Cᶠ₁₂₁₁*ε₁₁
                  #     error("wrong, $p1 ≠ $p2")
                  # end
                  #if (μ̄ *𝑝*signτ - τ)*2*n₁*s₁ ≠ (Cᶠ₁₁₁₁-Cʳ₁₁₁₁)*ε₁₁+(Cᶠ₁₁₁₂-Cʳ₁₁₁₂)*ε₁₂+(Cᶠ₁₁₂₂-Cʳ₁₁₂₂)*ε₂₂
                  # p1 = (μ̄ *𝑝*signτ - τ)*(n₁*s₂+n₂*s₁)
               #
                  # p2 = (Cᶠ₁₂₁₂-Cʳ₁₂₁₂)*ε₁₂+(Cᶠ₁₂₂₂-Cʳ₁₂₂₂)*ε₂₂+(Cᶠ₁₂₁₁-Cʳ₁₂₁₁)*ε₁₁
                  # error("wrong, $p1 ≠ $p2")
                  #end
                   ...
                   Cᵗ₁₁₁₁ = Cᵢᵢᵢᵢ + (1.0-v^2-η)*(Cᶠ₁₁₁₁-Cʳ₁₁₁₁)
                   Cᵗ₂₂₂₂ = Cᵢᵢᵢᵢ + (1.0-v^2-η)*(Cᶠ₂₂₂₂-Cʳ₂₂₂₂)
                   Cᵗ₁₁₂₂ = Cᵢᵢⱼⱼ + (1.0-v^2-η)*(Cᶠ₁₁₂₂-Cʳ₁₁₂₂)
                   Cᵗ₂₂₁₁ = Cᵢᵢⱼⱼ + (1.0-v^2-η)*(Cᶠ₂₂₁₁-Cʳ₂₂₁₁)
                   Cᵗ₁₂₁₂ = Cᵢⱼᵢⱼ + (1.0-v^2-η)*(Cᶠ₁₂₁₂-Cʳ₁₂₁₂)
                   Cᵗ₁₁₁₂ = (1.0-v^2-η)*(Cᶠ₁₁₁₂-Cʳ₁₁₁₂)
                   Cᵗ₁₂₁₁ = (1.0-v^2-η)*(Cᶠ₁₂₁₁-Cʳ₁₂₁₁)
                   Cᵗ₂₂₁₂ = (1.0-v^2-η)*(Cᶠ₂₂₁₂-Cʳ₂₂₁₂)
                   Cᵗ₁₂₂₂ = (1.0-v^2-η)*(Cᶠ₁₂₂₂-Cʳ₁₂₂₂)
