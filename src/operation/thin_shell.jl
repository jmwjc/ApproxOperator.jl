    ...
    for ξ in 𝓖
        ...
        for (i,xᵢ) in enumerate(𝓒)
            ...
            for (j,xⱼ) in enumerate(𝓒)
                ...
                k[3*I-2,3*J-2] -= ((Bᵢ₍₁₁₎*n₁₁+Bᵢ₍₁₂₎*n₁₂+Bᵢ₍₁₃₎*n₁₃)*N[j] + N[i]*(Bⱼ₍₁₁₎*n₁₁+Bⱼ₍₁₂₎*n₁₂+Bⱼ₍₁₃₎*n₁₃) - α*N[i]*n₁₁*N[j])*𝑤
                k[3*I-1,3*J-2] -= ((Bᵢ₍₂₁₎*n₁₁+Bᵢ₍₂₂₎*n₁₂+Bᵢ₍₂₃₎*n₁₃)*N[j] + N[i]*(Bⱼ₍₂₁₎*n₁₁+Bⱼ₍₂₂₎*n₁₂+Bⱼ₍₂₃₎*n₁₃) - α*N[i]*n₁₂*N[j])*𝑤
                k[3*I,3*J-2]   -= ((Bᵢ₍₃₁₎*n₁₁+Bᵢ₍₃₂₎*n₁₂+Bᵢ₍₃₃₎*n₁₃)*N[j] + N[i]*(Bⱼ₍₃₁₎*n₁₁+Bⱼ₍₃₂₎*n₁₂+Bⱼ₍₃₃₎*n₁₃) - α*N[i]*n₁₃*N[j])*𝑤
                k[3*I-2,3*J-1] -= ((Bᵢ₍₁₁₎*n₁₂+Bᵢ₍₁₂₎*n₂₂+Bᵢ₍₁₃₎*n₂₃)*N[j] + N[i]*(Bⱼ₍₁₁₎*n₁₂+Bⱼ₍₁₂₎*n₂₂+Bⱼ₍₁₃₎*n₂₃) - α*N[i]*n₁₂*N[j])*𝑤
                k[3*I-1,3*J-1] -= ((Bᵢ₍₂₁₎*n₁₂+Bᵢ₍₂₂₎*n₂₂+Bᵢ₍₂₃₎*n₂₃)*N[j] + N[i]*(Bⱼ₍₂₁₎*n₁₂+Bⱼ₍₂₂₎*n₂₂+Bⱼ₍₂₃₎*n₂₃) - α*N[i]*n₂₂*N[j])*𝑤
                k[3*I,3*J-1]   -= ((Bᵢ₍₃₁₎*n₁₂+Bᵢ₍₃₂₎*n₂₂+Bᵢ₍₃₃₎*n₂₃)*N[j] + N[i]*(Bⱼ₍₃₁₎*n₁₂+Bⱼ₍₃₂₎*n₂₂+Bⱼ₍₃₃₎*n₂₃) - α*N[i]*n₂₃*N[j])*𝑤
                k[3*I-2,3*J]   -= ((Bᵢ₍₁₁₎*n₁₃+Bᵢ₍₁₂₎*n₂₃+Bᵢ₍₁₃₎*n₃₃)*N[j] + N[i]*(Bⱼ₍₁₁₎*n₁₃+Bⱼ₍₁₂₎*n₂₃+Bⱼ₍₁₃₎*n₃₃) - α*N[i]*n₁₃*N[j])*𝑤
                k[3*I-1,3*J]   -= ((Bᵢ₍₂₁₎*n₁₃+Bᵢ₍₂₂₎*n₂₃+Bᵢ₍₂₃₎*n₃₃)*N[j] + N[i]*(Bⱼ₍₂₁₎*n₁₃+Bⱼ₍₂₂₎*n₂₃+Bⱼ₍₂₃₎*n₃₃) - α*N[i]*n₂₃*N[j])*𝑤
                k[3*I,3*J]     -= ((Bᵢ₍₃₁₎*n₁₃+Bᵢ₍₃₂₎*n₂₃+Bᵢ₍₃₃₎*n₃₃)*N[j] + N[i]*(Bⱼ₍₃₁₎*n₁₃+Bⱼ₍₃₂₎*n₂₃+Bⱼ₍₃₃₎*n₃₃) - α*N[i]*n₂₃*N[j])*𝑤
            end
            f[3*I-2] -= (Bᵢ₍₁₁₎*n₁₁*g₁+Bᵢ₍₁₂₎*n₁₂*g₂+Bᵢ₍₁₃₎*g₃ - α*N[i]*(n₁₁*g₁+n₁₂*g₂+n₁₃*g₃))*𝑤
            f[3*I-1] -= (Bᵢ₍₂₁₎*n₁₁*g₁+Bᵢ₍₂₂₎*n₁₂*g₂+Bᵢ₍₂₃₎*g₃ - α*N[i]*(n₁₂*g₁+n₂₂*g₂+n₂₃*g₃))*𝑤
            f[3*I]   -= (Bᵢ₍₃₁₎*n₁₁*g₁+Bᵢ₍₃₂₎*n₁₂*g₂+Bᵢ₍₃₃₎*g₃ - α*N[i]*(n₁₃*g₁+n₂₃*g₂+n₃₃*g₃))*𝑤
        end
    end
end
    ...
    for (ξᵃ,ξᵇ) in zip(𝓖ᵃ,𝓖ᵇ)
        ...
        for (i,xᵢ) in enumerate(𝓒ᵃ)
            ...
            for (j,xⱼ) in enumerate(𝓒ᵇ)
                J = xⱼ.𝐼
                k[3*I-2,3*J-2] += n₁*N[i]*(𝒂₁₍₁₎*n₁₁+𝒂₁₍₂₎*n₁₂+𝒂₁₍₂₎)*N̄[j]*𝑤
                k[3*I-1,3*J-2] += n₂*N[i]*𝒂₂₍₂₎*n₁₂*N̄[j]*𝑤
                k[3*I,3*J-2]   += n₁*N[i]*𝒂₁₍₃₎*n₁₂*N̄[j]*𝑤
                k[3*I-2,3*J-1] += n₂*N[i]*𝒂₁₍₁₎*n₁₂*N̄[j]*𝑤
                k[3*I-1,3*J-1] += n₁*N[i]*𝒂₁₍₁₎*n₁₃*N̄[j]*𝑤
                k[3*I,3*J-1]   += n₂*N[i]*𝒂₁₍₁₎*n₁₃*N̄[j]*𝑤
                k[3*I-2,3*J]   += n₁*N[i]*𝒂₁₍₁₎*n₁₂*N̄[j]*𝑤
                k[3*I-1,3*J]   += n₂*N[i]*𝒂₁₍₁₎*n₁₂*N̄[j]*𝑤
                k[3*I,3*J]     += n₁*N[i]*𝒂₁₍₁₎*n₂₂*N̄[j]*𝑤
            end
...
function (op::Operator{:∫∇𝑴𝒏𝒂₃𝒈dΓ_Nitsche})(ap::T;k::AbstractMatrix{Float64},f::AbstractVector{Float64}) where {T<:AbstractElement,S<:AbstractElement}
    ...
    for ξ in 𝓖
        ...
        for (i,xᵢ) in enumerate(𝓒)
            ...
            Mᵢ₍₁₁₎ = (M¹¹₁₍₁₎*𝒂³₍₁₎ + M¹¹₍₁₎*∂₁𝒂³₍₁₎)*s₁*n₁*s¹         + (M¹¹₂₍₁₎*𝒂³₍₁₎ + M¹¹₍₁₎*∂₂𝒂³₍₁₎)*s₁*n₁*s²
                   + (M²²₁₍₁₎*𝒂³₍₁₎ + M²²₍₁₎*∂₁𝒂³₍₁₎)*s₂*n₂*s¹         + (M²²₂₍₁₎*𝒂³₍₁₎ + M²²₍₁₎*∂₂𝒂³₍₁₎)*s₂*n₂*s²
                   + (M¹²₁₍₁₎*𝒂³₍₁₎ + M¹²₍₁₎*∂₁𝒂³₍₁₎)*(s₁*n₂+s₂*n₁)*s¹ + (M¹²₂₍₁₎*𝒂³₍₁₎ + M¹²₍₁₎*∂₂𝒂³₍₁₎)*(s₁*n₂+s₂*n₁)*s²
            ...
            for (j,xⱼ) in enumerate(𝓒)
                ...
                Mⱼ₍₁₁₎ = (M¹¹₁₍₁₎*𝒂³₍₁₎ + M¹¹₍₁₎*∂₁𝒂³₍₁₎)*s₁*n₁*s¹         + (M¹¹₂₍₁₎*𝒂³₍₁₎ + M¹¹₍₁₎*∂₂𝒂³₍₁₎)*s₁*n₁*s²
                       + (M²²₁₍₁₎*𝒂³₍₁₎ + M²²₍₁₎*∂₁𝒂³₍₁₎)*s₂*n₂*s¹         + (M²²₂₍₁₎*𝒂³₍₁₎ + M²²₍₁₎*∂₂𝒂³₍₁₎)*s₂*n₂*s²
                       + (M¹²₁₍₁₎*𝒂³₍₁₎ + M¹²₍₁₎*∂₁𝒂³₍₁₎)*(s₁*n₂+s₂*n₁)*s¹ + (M¹²₂₍₁₎*𝒂³₍₁₎ + M¹²₍₁₎*∂₂𝒂³₍₁₎)*(s₁*n₂+s₂*n₁)*s²
            ...
            f[3*I-2] -= ((Qᵢ₍₁₁₎ + Mᵢ₍₁₁₎)*n₁₁*g₁ + (Qᵢ₍₁₂₎ + Mᵢ₍₁₂₎)*n₁₂*g₂ + (Qᵢ₍₁₃₎ + Mᵢ₍₁₃₎)*n₁₃*g₃ - α*N[i]*(n₁₁*g₁+n₁₂*g₂+n₁₃*g₃))*𝑤
            f[3*I-1] -= ((Qᵢ₍₂₁₎ + Mᵢ₍₂₁₎)*n₁₂*g₁ + (Qᵢ₍₂₂₎ + Mᵢ₍₂₂₎)*n₂₂*g₂ + (Qᵢ₍₂₃₎ + Mᵢ₍₂₃₎)*n₂₃*g₃ - α*N[i]*(n₁₂*g₁+n₂₂*g₂+n₂₃*g₃))*𝑤
            f[3*I]   -= ((Qᵢ₍₃₁₎ + Mᵢ₍₃₁₎)*n₁₃*g₁ + (Qᵢ₍₃₂₎ + Mᵢ₍₃₂₎)*n₂₃*g₂ + (Qᵢ₍₃₃₎ + Mᵢ₍₃₃₎)*n₃₃*g₃ - α*N[i]*(n₁₃*g₁+n₂₃*g₂+n₃₃*g₃))*𝑤
        end
    end
end
...
function (op::Operator{:∫∇𝑴𝒏𝒂₃𝒈dΓ_HR})(a::T,b::S;k::AbstractMatrix{Float64},f::AbstractVector{Float64}) where {T<:AbstractElement,S<:AbstractElement}
    ...
    for (ξᵃ,ξᵇ) in zip(𝓖ᵃ,𝓖ᵇ)
        ...
        for (i,xᵢ) in enumerate(𝓒ᵃ)
            I = xᵢ.𝐼
            B̃₁₁ = B₁[i]*n₁ + N[i]*Γᵞᵧ₁n₁ + B₁[i]s₁n₁s¹ + B₂[i]s₁n₁s²
            B̃₂₂ = B₂[i]*n₂ + N[i]*Γᵞᵧ₂n₂ + B₁[i]s₂n₂s¹ + B₂[i]s₂n₂s²
            B̃₁₂ = B₁[i]*n₂ + B₂[i]*n₁ + N[i]*(Γᵞᵧ₁n₂+Γᵞᵧ₂n₁) + B₁[i]*(s₁n₂s¹+s₂n₁s¹) + B₂[i]*(s₁n₂s²+s₂n₁s²) 
            for (j,xⱼ) in enumerate(𝓒ᵇ)
                J = xⱼ.𝐼
...
function (op::Operator{:∫MₙₙθₙdΓ_Nitsche})(ap::T;k::AbstractMatrix{Float64},f::AbstractVector{Float64}) where {T<:AbstractElement,S<:AbstractElement}
    ...
    for ξ in 𝓖
        ...
        for (i,xᵢ) in enumerate(𝓒)
            ...
            f[3*I-2] += (M₍₁₎ᵢ + α*θ₍₁₎ᵢ)*θ*𝑤
            f[3*I-1] += (M₍₂₎ᵢ + α*θ₍₂₎ᵢ)*θ*𝑤
            f[3*I]   += (M₍₃₎ᵢ + α*θ₍₃₎ᵢ)*θ*𝑤
        end
    end
end
