    ...
    for ξ in 𝓖
        ...
        for (i,xᵢ) in enumerate(𝓒)
            ...
            for (j,xⱼ) in enumerate(𝓒)
                ...
                k[3*I-2,3*J-2] += ((Bᵢ₍₁₁₎*n₁₁+Bᵢ₍₁₂₎*n₁₂+Bᵢ₍₁₃₎*n₁₃)*N[j] + N[i]*(Bⱼ₍₁₁₎*n₁₁+Bⱼ₍₁₂₎*n₁₂+Bⱼ₍₁₃₎*n₁₃)+ α*N[i]*N[j])*𝑤
                k[3*I-1,3*J-2] += ((Bᵢ₍₂₁₎*n₁₁+Bᵢ₍₂₂₎*n₁₂+Bᵢ₍₂₃₎*n₁₃)*N[j] + N[i]*(Bⱼ₍₂₁₎*n₁₁+Bⱼ₍₂₂₎*n₁₂+Bⱼ₍₂₃₎*n₁₃)+ α*N[i]*N[j])*𝑤
                k[3*I,3*J-2]   += ((Bᵢ₍₃₁₎*n₁₁+Bᵢ₍₃₂₎*n₁₂+Bᵢ₍₃₃₎*n₁₃)*N[j] + N[i]*(Bⱼ₍₃₁₎*n₁₁+Bⱼ₍₃₂₎*n₁₂+Bⱼ₍₃₃₎*n₁₃)+ α*N[i]*N[j])*𝑤
                k[3*I-2,3*J-1] += ((Bᵢ₍₁₁₎*n₁₂+Bᵢ₍₁₂₎*n₂₂+Bᵢ₍₁₃₎*n₂₃)*N[j] + N[i]*(Bⱼ₍₁₁₎*n₁₂+Bⱼ₍₁₂₎*n₂₂+Bⱼ₍₁₃₎*n₂₃)+ α*N[i]*N[j])*𝑤
                k[3*I-1,3*J-1] += ((Bᵢ₍₂₁₎*n₁₂+Bᵢ₍₂₂₎*n₂₂+Bᵢ₍₂₃₎*n₂₃)*N[j] + N[i]*(Bⱼ₍₂₁₎*n₁₂+Bⱼ₍₂₂₎*n₂₂+Bⱼ₍₂₃₎*n₂₃)+ α*N[i]*N[j])*𝑤
                k[3*I,3*J-1]   += ((Bᵢ₍₃₁₎*n₁₂+Bᵢ₍₃₂₎*n₂₂+Bᵢ₍₃₃₎*n₂₃)*N[j] + N[i]*(Bⱼ₍₃₁₎*n₁₂+Bⱼ₍₃₂₎*n₂₂+Bⱼ₍₃₃₎*n₂₃)+ α*N[i]*N[j])*𝑤
                k[3*I-2,3*J]   += ((Bᵢ₍₁₁₎*n₁₃+Bᵢ₍₁₂₎*n₂₃+Bᵢ₍₁₃₎*n₃₃)*N[j] + N[i]*(Bⱼ₍₁₁₎*n₁₃+Bⱼ₍₁₂₎*n₂₃+Bⱼ₍₁₃₎*n₃₃)+ α*N[i]*N[j])*𝑤
                k[3*I-1,3*J]   += ((Bᵢ₍₂₁₎*n₁₃+Bᵢ₍₂₂₎*n₂₃+Bᵢ₍₂₃₎*n₃₃)*N[j] + N[i]*(Bⱼ₍₂₁₎*n₁₃+Bⱼ₍₂₂₎*n₂₃+Bⱼ₍₂₃₎*n₃₃)+ α*N[i]*N[j])*𝑤
                k[3*I,3*J]     += ((Bᵢ₍₃₁₎*n₁₃+Bᵢ₍₃₂₎*n₂₃+Bᵢ₍₃₃₎*n₃₃)*N[j] + N[i]*(Bⱼ₍₃₁₎*n₁₃+Bⱼ₍₃₂₎*n₂₃+Bⱼ₍₃₃₎*n₃₃)+ α*N[i]*N[j])*𝑤
            end
            f[3*I-2] += + α*N[i]*(Bᵢ₍₁₁₎*n₁₁*g₁+Bᵢ₍₁₂₎*n₁₂*g₂+Bᵢ₍₁₃₎*g₃)*𝑤
            f[3*I-1] += + α*N[i]*(Bᵢ₍₂₁₎*n₁₁*g₁+Bᵢ₍₂₂₎*n₁₂*g₂+Bᵢ₍₂₃₎*g₃)*𝑤
            f[3*I]   += + α*N[i]*(Bᵢ₍₃₁₎*n₁₁*g₁+Bᵢ₍₃₂₎*n₁₂*g₂+Bᵢ₍₃₃₎*g₃)*𝑤
        end
    end
end
