...
get𝑛𝑝(::PiecewiseParametric{:Bubble,:Tet4}) = 1
...
function set𝝭!(::PiecewisePolynomial{:Quadratic3D}, 𝒙::Node)
    𝝭 = 𝒙[:𝝭]
    x = 𝒙.x
    y = 𝒙.y
    z = 𝒙.z
...
function set∇𝝭!(::PiecewisePolynomial{:Quadratic3D}, 𝒙::Node)
    𝝭 = 𝒙[:𝝭]
    x = 𝒙.x
    y = 𝒙.y
    z = 𝒙.z
...
function set𝝭!(::PiecewiseParametric{:Bubble,:Tet4},𝒙::Node)
    𝝭 = 𝒙[:𝝭]
    ξ = 𝒙.ξ
    η = 𝒙.η
    γ = 𝒙.γ 
...
function set∇𝝭!(::PiecewiseParametric{:Bubble,:Tet4},𝒙::Node)
    𝝭 = 𝒙[:𝝭]
    ξ = 𝒙.ξ
    η = 𝒙.η
    γ = 𝒙.γ 
    ...
    ∂𝝭∂y = 𝒙[:∂𝝭∂y]
    ∂𝝭∂z = 𝒙[:∂𝝭∂z]
    ∂𝝭∂x[1] = 256.0*(η*γ*𝒙.∂ξ∂x + ξ*γ*𝒙.∂η∂x + ξ*η*𝒙.∂γ∂x)
    ∂𝝭∂y[1] = 256.0*(η*γ*𝒙.∂ξ∂y + ξ*γ*𝒙.∂η∂y + ξ*η*𝒙.∂γ∂y)
    ∂𝝭∂z[1] = 256.0*(η*γ*𝒙.∂ξ∂z + ξ*γ*𝒙.∂η∂z + ξ*η*𝒙.∂γ∂z)
end
