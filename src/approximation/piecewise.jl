...
function set∇𝝭!(::PiecewiseParametric{:Bubble,:Tet4},𝒙::Node)
    ...
    ∂𝝭∂x[1] = 256.0*(η*γ*(1.0-2*ξ-η-γ)*𝒙.∂ξ∂x + ξ*γ*(1.0-ξ-2*η-γ)*𝒙.∂η∂x + ξ*η*(1.0-ξ-η-2*γ)*𝒙.∂γ∂x)
    ∂𝝭∂y[1] = 256.0*(η*γ*(1.0-2*ξ-η-γ)*𝒙.∂ξ∂y + ξ*γ*(1.0-ξ-2*η-γ)*𝒙.∂η∂y + ξ*η*(1.0-ξ-η-2*γ)*𝒙.∂γ∂y)
    ∂𝝭∂z[1] = 256.0*(η*γ*(1.0-2*ξ-η-γ)*𝒙.∂ξ∂z + ξ*γ*(1.0-ξ-2*η-γ)*𝒙.∂η∂z + ξ*η*(1.0-ξ-η-2*γ)*𝒙.∂γ∂z)
end
