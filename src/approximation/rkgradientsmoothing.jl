...
function set𝝭!(ap::RKGradientSmoothing{:Quadratic2D,𝑠,𝜙,:Tri3}) where {𝑠,𝜙}
    𝓒 = ap.𝓒
    𝓖 = ap.𝓖
    𝓖ˢ = ap.𝓖ˢ
    𝐴 = ap.𝐴
    ...
    D₃₂ = ap.D₃₂
    for ξ̂ in 𝓖
        N̂ = (ξ̂.ξ,ξ̂.η,1.0-ξ̂.ξ-ξ̂.η,0.0,0.0,0.0)
        B̂₁ = (-D₁₁/2/𝐴,-D₂₁/2/𝐴,-D₃₁/2/𝐴,0.0,0.0,0.0)
        B̂₂ = (-D₁₂/2/𝐴,-D₂₂/2/𝐴,-D₃₂/2/𝐴,0.0,0.0,0.0)
        𝝭 = ξ̂[:𝝭]
        ∂𝝭∂x = ξ̂[:∂𝝭∂x]
        ∂𝝭∂y = ξ̂[:∂𝝭∂y]
